...
public class MovieList extends javax.swing.JFrame {
    ...
    private DefaultTableModel tableModel = new javax.swing.table.DefaultTableModel(
            new Object[][]{},
            new String[]{
                "ID", "电影名", "导演", "主演", "封面", "类型", "票价"
            }
    ) {
        Class[] types = new Class[]{
            java.lang.Long.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.Float.class
        };
    ...
    private ArrayList<MovieDao> movies;
    /**
    ...
    public void fillTable() {
        ...
        String director = this.jTextField3.getText();
        String starring = this.jTextField4.getText();
        String type = this.jTextField5.getText();

        MovieDao movieDao = new MovieDao();

        if (id.length() > 0) {
            movieDao.where("id", "=", Long.valueOf(id));
        }
        ...
        for (MovieDao movie : this.movies) {
            Object[] row = {
                movie.getId(),
                movie.getName(),
                movie.getDirector(),
